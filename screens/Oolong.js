...
<ScrollView>
  ...
  <TouchableOpacity>
      ...
      <View style={styles.article}>
          <Text style={{fontSize:18, fontWeight:'bold'}}>Lets talk about Oolong tea{"\n"}</Text>
       
          <Text style={styles.textstyle}>Oolong or wulong, as it is also written, originally comes from Wuyi-shan in the Fujian province of China. 
          However, oolong teas are now produced in many places around the world, such as Taiwan, India, and Ceylon. {"\n"} </Text>
            <></>
            <Text style={styles.textstyle}>Oolong tea is a very varied type of tea. Oolong is partially fermented, like black tea, but the oxidation process is shorter, as it is interrupted when the desired result is achieved. 
            ...
            <Text style={styles.textstyle}>  The appearance of oolong tea can vary from tightly rolled leaves in the form of small balls, also known as "gunpowder tea," to twisted leaves similar to the appearance of black tea. Formosa oolong is a type of oolong tea that originates from Taiwan. 
            ...
            <Text style={styles.textstyle}> As oolong tea can resemble both black and green tea, it is sometimes mistakenly referred to as black or green tea by those who are unaware of its distinct qualities. 
            Be sure to ask the staff at the store where you purchase your tea to ensure that you are getting the correct type of tea!</Text>
              </View>
